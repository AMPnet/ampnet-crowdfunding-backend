...
===== Email used
.Request
include::{snippets}/RegistrationControllerTest/mustReturnTrueIfEmailExists/http-request.adoc[]
.Response
include::{snippets}/RegistrationControllerTest/mustReturnTrueIfEmailExists/http-response.adoc[]

===== Email not used
.Request
include::{snippets}/RegistrationControllerTest/mustReturnFalseForNonExistingEmail/http-request.adoc[]
.Response
include::{snippets}/RegistrationControllerTest/mustReturnFalseForNonExistingEmail/http-response.adoc[]
...
===== Successfully get transaction for creating organization wallet
.Request
