...
.Request
include::{snippets}/ProjectControllerTest/mustBeAbleToPostSignedTransaction/http-request.adoc[]
.Response
include::{snippets}/ProjectControllerTest/mustBeAbleToPostSignedTransaction/http-response.adoc[]
