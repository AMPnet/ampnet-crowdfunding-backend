...
=== Get all projects
.Request
include::{snippets}/ProjectPublicControllerTest/mustBeAbleToGetAllProjects/http-request.adoc[]
.Response
include::{snippets}/ProjectPublicControllerTest/mustBeAbleToGetAllProjects/http-response.adoc[]
