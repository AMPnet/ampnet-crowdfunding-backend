...
=== Identyum token
.Request
include::{snippets}/RegistrationControllerTest/mustBeAbleToGetIdentyumToken/http-request.adoc[]
.Response
include::{snippets}/RegistrationControllerTest/mustBeAbleToGetIdentyumToken/http-response.adoc[]
