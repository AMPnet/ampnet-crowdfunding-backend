...
Wallet token is used for wallet creation

.Request
include::{snippets}/WalletControllerTest/mustGenerateWalletTokenToCreateWallet/http-request.adoc[]
.Response
include::{snippets}/WalletControllerTest/mustGenerateWalletTokenToCreateWallet/http-response.adoc[]

===== Failed to generate token if user has wallet
.Request
include::{snippets}/WalletControllerTest/mustNotGenerateWalletTokenIfUserHasWallet/http-request.adoc[]
.Response
include::{snippets}/WalletControllerTest/mustNotGenerateWalletTokenIfUserHasWallet/http-response.adoc[]
...
.Request
include::{snippets}/OrganizationControllerTest/mustBeAbleToAddDocumentForProject/http-request.adoc[]
.Response
include::{snippets}/OrganizationControllerTest/mustBeAbleToAddDocumentForProject/http-response.adoc[]
