...
=== Broadcast transaction to create organization wallet
.Request
...
=== Broadcast transaction to create project wallet
.Request
include::{snippets}/BroadcastTransactionControllerTest/mustBeAbleToCreateProjectWalletWithTransaction/http-request.adoc[]
.Response
include::{snippets}/BroadcastTransactionControllerTest/mustBeAbleToCreateProjectWalletWithTransaction/http-response.adoc[]

=== Broadcast transaction invest allowance
.Request
include::{snippets}/BroadcastTransactionControllerTest/mustBeAbleToPostSignedInvestAllowanceTransaction/http-request.adoc[]
.Response
include::{snippets}/BroadcastTransactionControllerTest/mustBeAbleToPostSignedInvestAllowanceTransaction/http-response.adoc[]

=== Broadcast transaction invest
.Request
include::{snippets}/BroadcastTransactionControllerTest/mustBeAbleToPostSignedInvestTransaction/http-request.adoc[]
.Response
include::{snippets}/BroadcastTransactionControllerTest/mustBeAbleToPostSignedInvestTransaction/http-response.adoc[]
