...
===== Successfully create
.Request
include::{snippets}/WalletControllerTest/mustBeAbleToCreateProjectWalletWithTransaction/http-request.adoc[]
.Response
include::{snippets}/WalletControllerTest/mustBeAbleToCreateProjectWalletWithTransaction/http-response.adoc[]
...
===== Create organization wallet
.Request
include::{snippets}/WalletControllerTest/mustBeAbleToCreateOrganizationWallet/http-request.adoc[]
.Response
include::{snippets}/WalletControllerTest/mustBeAbleToCreateOrganizationWallet/http-response.adoc[]
...
==== Send signed transaction to greenvest
.Request
include::{snippets}/ProjectControllerTest/mustBeAbleToPostSignedInvestTransaction/http-request.adoc[]
.Response
include::{snippets}/ProjectControllerTest/mustBeAbleToPostSignedInvestTransaction/http-response.adoc[]

=== Approve Greenvestment
...
==== Send signed transaction to approve greenvestment
.Request
include::{snippets}/ProjectControllerTest/mustBeAbleToPostSignedConfirmInvestTransaction/http-request.adoc[]
.Response
include::{snippets}/ProjectControllerTest/mustBeAbleToPostSignedConfirmInvestTransaction/http-response.adoc[]
